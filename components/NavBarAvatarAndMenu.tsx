...
export default function NavBarAvatarAndMenu({session}:{session:Session}){
    ...
    return (
        ...
        <div id="avatarButton" data-dropdown-toggle="userDropdown" className="cursor-pointer relative w-8 h-8 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
